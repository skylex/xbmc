...
#pragma warning(disable:4244)
    ...
    // check ffmpeg version before including opt.h (it is not needed with latests revision)
...
public:
  ...
  // need to check ffmpeg version before defining av_set_string (now it is av_set_string3 in AvUtil)
